...
from cardtable.paths import ASSETS, CONFIGURATION, FRONTEND, INTERFACE, REPOSITORY
...
def test_the_configuration_stands_in_the_repository_as_a_file_a_run_reads() -> None:
    assert CONFIGURATION.parent == REPOSITORY
