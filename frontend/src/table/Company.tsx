...
/**
 * Who is at the table: one place per seat the choice settled, and the guests standing by beside them.
 *
 ...
 */
export function Company({ gathering, claim }: CompanyProps): ReactElement {
...
function Place({ gathering, seat, claim }: PlaceProps): ReactElement {
  ...
  return (
    <li className={classes("place", holder === null ? "empty" : "taken", own && "own")}>
